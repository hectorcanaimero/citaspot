...
export default function PipelinePage() {
  ...
  async function handleLoadTemplate() {
    ...
    try {
      await pipelineStages.loadTemplate();
      await load();
    } catch {
      setTemplateError(t.crm.pipeline.loadTemplateError);
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-16 text-center">
          ...
          <button
            ...
            className="rounded-lg bg-primary-600 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-primary-500 disabled:opacity-50"
          >
            {loadingTemplate ? t.crm.pipeline.loadingTemplate : t.crm.pipeline.loadTemplate}
          </button>
          {templateError && (
