...
import { MessageCircle, CheckCircle2, XCircle, RefreshCw, Loader2, Unplug } from 'lucide-react';
            ...
            <div className="flex flex-col gap-4">
              ...
              {isConnecting && (
                <div className="flex flex-col items-center gap-3 rounded-lg border border-primary-100 bg-primary-50 p-5">
                  ...
                  <ol className="text-xs text-primary-700 text-left space-y-1 mt-1">
                    <li>{t.whatsapp.step1}</li>
                    <li>{t.whatsapp.step2Detail}</li>
                    <li>{t.whatsapp.step3Detail}</li>
                  </ol>
