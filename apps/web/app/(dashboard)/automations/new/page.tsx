...
export default function NewRulePage() {
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    name, description, triggerType, triggerEvent, intervalDays, referenceField,
    conditions, actions, cooldownHours, router, ta, t.common.error,
  ]);
  ...
  return (
    <div className="mx-auto max-w-2xl p-6">
      ...
      <div className="mb-6 flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-semibold text-neutral-900">{ta.createTitle}</h1>
        </div>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="flex justify-end gap-3">
          ...
          >
            ...
            {saving ? ta.saving : t.common.save}
          </button>
        </div>
      </form>
    </div>
